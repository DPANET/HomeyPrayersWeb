import { ILocationSettings as locationlib } from './location';
...
export declare class PrayersTime implements IPrayersTime {
    constructor(prayers: Array<IPrayers>, locationSettings: locationlib, prayerConfig: IPrayersSettings);
    private _location;
    get location(): locationlib;
    set location(value: locationlib);
