...
import { i as isNullOrUndefined_1 } from '../../../../common/location-9d67a0d3.js';
import prayer from '../entities/prayer.js';
...
var interface_validators = createCommonjsModule(function (module, exports) {
...
const prayer = __importStar(prayer.__moduleExports);

class LocationValidator extends interface_validators.Validator {
    constructor() {
        super(interface_validators.ValidatorProviders.LocationValidator);
...
class PrayerSettingsValidator extends interface_validators.Validator {
    constructor() {
        super(interface_validators.ValidatorProviders.PrayerSettingsValidator);
...
class PrayerConfigValidator extends interface_validators.Validator {
    constructor() {
        super(interface_validators.ValidatorProviders.PrayerConfigValidator);
        this.setSchema();
    }
    setSchema() {
        this._adjustmentsSchema = joi_1.default.object().keys({
...
class LocationConfigValidator extends interface_validators.Validator {
    constructor() {
        super(interface_validators.ValidatorProviders.LocationConfigValidator);
        this.setSchema();
    }
    setSchema() {
